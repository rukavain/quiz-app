const images = {
  catFlower: new URL("./flower-cat.jpg", import.meta.url).href,
  catDate: new URL("./date-cat.jpg", import.meta.url).href,
  catFood: new URL("./food-cat.jpg", import.meta.url).href,
  food1: new URL("./makimura.jpg", import.meta.url).href,
  food2: new URL("./sumoniku.jpg", import.meta.url).href,
